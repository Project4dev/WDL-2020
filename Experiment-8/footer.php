...
<footer class="py-3 px-5 text-white mt-5" style = "background-color: #050000; font-family: 'Noto Sans KR', sans-serif;">
            <div class="row">
                <div class=" col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                    <div class="text-center">
                        <h4><b>Quicks links</b></h4>
                        <ul>
                            <li><i><a href="index.php" >HOME</a></i></li>
                            <a href="rent.php" ><li>RENT</li></a>
                            <a href="post.php" ><li><i>SELL</i></li></a>
                            <a href="about.php" ><li><i>ABOUT</i></li></a>
                        </ul>
                    </div>
                    <br>
                </div>
